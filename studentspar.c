...
int main(void)
{
    ...
    for (i = 0; i < R*C*A; i++)
    {
        matriz[i] = matrizOrdenada[i] = rand() % 100;
    }
    ...
    // Mediana da cidade
    ordena_linhas(matrizOrdenada, R*C, A);
    encontra_maiores(matrizOrdenada, maior_cidades, R*C, A);
    encontra_menores(matrizOrdenada, menor_cidades, R*C, A);
    calcula_mediana(matrizOrdenada, mediana_cidades, R*C, A);
    ...
    // Mediana da regiao
    ordena_linhas(matrizOrdenada, R, A*C);
    encontra_maiores(matrizOrdenada, maior_regiao, R, A*C);
    encontra_menores(matrizOrdenada, menor_regiao, R, A*C);
    calcula_mediana(matrizOrdenada, mediana_regiao, R, A*C);
    ...
    // Mediana do Brasil
    ordena_linhas(matrizOrdenada, 1, A*C*R);
    encontra_maiores(matrizOrdenada, &maior_brasil, 1, A*C*R);
    encontra_menores(matrizOrdenada, &menor_brasil, 1, A*C*R);
    calcula_mediana(matrizOrdenada, &mediana_brasil, 1, A*C*R);
